...
class Phone(str):
    ...
    PHONES = \
      {'am':
        ...
        'r', 'rW', 's', 'sW', 'S', 'SW', 't', 'tW', 'T', 'TW', \
        'x', 'xW', 'z', 'zW', 'Z', 'ZW',
        'w_', 'y_',  'b_', 'bW_', 'c_', 'cW_', 'C_', 'CW_', 'd_', 'dW_', \
        'f_', 'fW_', 'g_', 'gW_', 'j_', 'jW_', 'k_', 'kW_', 'l_', 'lW_', \
        'm_', 'mW_', 'n_', 'nW_', 'N_', 'NW_', 'q_', 'qW_', \
        'r_', 'rW_', 's_', 'sW_', 'S_', 'SW_', 't_', 'tW_', 'T_', 'TW_', \
        'x_', 'xW_', 'z_', 'zW_', 'Z_', 'ZW_'
        ],
        [
        'I', 'p', 'pW', 'P', 'PW', 'v', 'vW', \
        '^s', '^S', '^h', '^hW', '^sW', '^SW'
